...
Path::Path(const QString &name,float distance,float current_distance)
    : m_name(name),m_distance(distance),m_rest_distance(current_distance),m_current_distance(current_distance),m_complete(false)
{
